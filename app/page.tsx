...
const jobs = [
  {
    period: 'Март 2023 — Сентябрь 2026',
    duration: '3 года и 7 месяцев',
    company: 'Яндекс Практикум',
    role: 'Фронтенд-разработчик / Технический менеджер (t-shape)',
    intro: 'Работала на стыке продуктовой разработки и технического менеджмента: проектировала и запускала пользовательские решения, автоматизировала процессы вывода новых продуктов. Вела задачи от постановки и выбора технического решения до релиза и дальнейшего масштабирования. Самостоятельно разрабатывала решения под ключ с помощью AI.',
    sections: [
      {
        title: 'Разработка',
        duties: [
...
const projects = [
  {
    title: 'Конструктор домашнего меню «Оливье»',
  ...
  },
  {
    ...
    description: 'Адаптивное одностраничное резюме с\u00A0навыками, опытом, пет-проектами, рекомендациями, образованием и\u00A0контактами. Интерфейс разработан на\u00A0React и\u00A0TypeScript с\u00A0использованием Vinext и\u00A0Tailwind CSS, а\u00A0версия для\u00A0GitHub Pages собирается как\u00A0статический сайт.',
  },
];
    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <p className="hero-role">Frontend Developer · Product Engineer</p>
          <div className="hero-summary">
            ...
            <li>· Технический менеджмент: сбор требований, формулирование и декомпозиция задач, планирование, стандартизация подходов.</li>
            <li>· 350+ страниц в проде.</li>
            <li>· Применяю AI для быстрой и эффективной работы на всех этапах.</li>
            </ul>
          </div>
          ...
          <div className="hero-actions">
            ...
            <div className="social-links" aria-label="Социальные сети">
              ...
              <a href="https://github.com/Kozina-Kate" target="_blank" rel="noreferrer" aria-label="Профиль Екатерины на GitHub">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <path fill="currentColor" d="M12 1C5.923 1 1 5.923 1 12c0 4.867 3.149 8.979 7.521 10.436.55.096.756-.233.756-.522 0-.262-.013-1.128-.013-2.049-2.764.509-3.479-.674-3.699-1.292-.124-.317-.66-1.293-1.128-1.554-.385-.206-.935-.715-.014-.729.866-.014 1.485.797 1.691 1.128.99 1.663 2.571 1.196 3.204.907.096-.715.385-1.196.701-1.471-2.448-.275-5.005-1.224-5.005-5.432 0-1.196.426-2.186 1.128-2.956-.111-.275-.496-1.402.11-2.915 0 0 .921-.288 3.024 1.128a10.2 10.2 0 0 1 2.75-.371c.935 0 1.87.123 2.75.371 2.104-1.43 3.025-1.128 3.025-1.128.605 1.526.22 2.64.11 2.915.701.77 1.127 1.747 1.127 2.956 0 4.221-2.571 5.157-5.019 5.432.399.344.743 1.004.743 2.035 0 1.471-.014 2.654-.014 3.025 0 .289.206.632.756.522C19.851 20.979 23 16.854 23 12c0-6.077-4.922-11-11-11Z" />
                </svg>
              </a>
            </div>
          </div>
      ...
      <section className="experience-section" id="experience">
        <div className="experience-inner">
          <SectionHeading
            ...
            text="Более пяти лет в продуктовой разработке, автоматизации процессов и техническом менеджменте."
          />
