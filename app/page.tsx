...
const jobs = [
  {
    ...
    intro: 'Проектировала и запускала пользовательские решения, автоматизировала процессы. Вела задачи от постановки и выбора технических средств до непосредственно разработки, релиза и дальнейшего масштабирования. Самостоятельно разрабатывала решения под ключ с помощью AI.',
    sections: [
      {
        title: 'Разработка',
        duties: [
