...
const jobs = [
  {
    ...
    intro: 'Работала на стыке продуктовой разработки и технического менеджмента: проектировала и запускала пользовательские решения, автоматизировала процессы. Вела задачи от постановки и выбора технических средств до релиза и дальнейшего масштабирования. Самостоятельно разрабатывала решения под ключ с помощью AI.',
    sections: [
      {
        title: 'Разработка',
        duties: [
