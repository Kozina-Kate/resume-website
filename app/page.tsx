...
const jobs = [
  {
    ...
    intro: 'Разрабатывала страницы, интерфейсы, проектировала и запускала пользовательские решения, автоматизировала процессы. Вела задачи от постановки и выбора технических средств до релиза и дальнейшего масштабирования.',
    sections: [
      {
        title: 'Разработка',
        duties: [
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-summary">
            ...
            <li>· Также разрабатываю внутренние сервисы для автоматизации процессов.</li>
            <li>· Применяю AI для ускорения работы на всех этапах.</li>
            </ul>
          </div>
      ...
      <section className="experience-section" id="experience">
        <div className="experience-inner">
          <SectionHeading
            ...
            text="5+ лет в разработке, автоматизации процессов и техническом менеджменте."
          />
      ...
      <section className="education-section" id="education">
        <div className="education-inner">
          <SectionHeading
            ...
            text="Я люблю учиться и периодически прохожу курсы, чтобы актуализировать и систематизировать знания. Если подходящего курса нет, создаю собственный (см. мои пет-проекты)."
          />
